...
import './ToggleAnnotation.js';
import './PlaybackRate/PlaybackRateSettingItem.js';
import './Quality/QualitySettingItem.js';
import './Subtitles/SubtitlesSettingItem.js';

const MenuButton = videojs.getComponent('MenuButton');

class SettingMenus extends MenuButton {
    ...
    createMenu() {
        ...
        entries.forEach(componentName => {
            const component = menu.addChild(componentName, { menu });
...
SettingMenus.prototype.controlText_ = 'Settings';
SettingMenus.prototype.options_ = {
    entries: [
        'ToggleAnnotation',
        'PlaybackRateSettingItem',
        'SubtitlesSettingItem',
        'QualitySettingItem'
    ]
};

videojs.registerComponent('SettingMenus', SettingMenus);
